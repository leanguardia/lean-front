  ...
  const shineStyle = {
    ...
    backgroundImage: `
      ...
      radial-gradient(
        ...
        hsla(160, 50%, 70%, 0.2) 12%,
        hsla(160, 40%, 60%, 0.15) 20%,
        hsla(160, 30%, 50%, 0.1) 120%
      )
    `.replace(/\s+/g, ' '),
    gridArea: '1 / -1',
      ...
      <div ref={shellRef} className="relative z-[1] group w-full h-full">
        ...
        >
          ...
          >
            ...
            >
              <img
                className="w-full h-full absolute left-1/2 will-change-transform transition-transform duration-[120ms] ease-out object-cover"
                src={avatarUrl}
